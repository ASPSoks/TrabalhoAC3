...
Para executar os testes, após fazer a instalação correta do Sniper e todos os componentes necessários em uma VM, WSL ou Linux nativo, adicionar o arquivo matmul.c à pasta do snipersim, executar os códigos de configuração descritos no documento códigos AC3, e executar no terminal:
- cd snipersim
